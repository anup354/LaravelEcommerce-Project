<main class="bg-white">
    <div x-cloak x-data="sidebar()" class="relative flex items-start ">
            ...
            <div class="flex justify-end">
                <button @click="sidebarOpen = !sidebarOpen"
                    ...
                    <svg viewBox="0 0 20 20" class="w-6 h-6 fill-current"
                        :class="{ 'text-[#4456a6]': !sidebarOpen, 'text-red-500 hover:text-white': sidebarOpen }">
        ...
        <div x-cloak wire:ignore :class="{ 'w-56': sidebarOpen, 'w-0': !sidebarOpen }"
            class="fixed left-0 z-30 block w-56 h-full min-h-screen  font-semibold transition-all duration-300 ease-in-out  text-[#4456a6] shadow-lg overflow-x-hidden">
            ...
            <div class="flex flex-col items-stretch justify-between overflow-y-scroll h-[90vh]">
                <div class="flex flex-col flex-shrink-0 w-full">
                    <div class="flex items-center justify-center px-8 py-3 text-center">
                        <a href="#" class="text-lg leading-normal text-[#4456a6] font-bold ">
                            {{ Auth::guard('customer_registrations')->user()->name }}
                        </a>
                    </div>
                    ...
                    <nav class="">
                        <div class="flex-grow md:block md:overflow-y-auto overflow-x-hidden"
                            ...
                            <a class="{!! request()->segment(2) == 'dashboard' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex justify-start items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white"
                            ...
                            <a class="{!! request()->segment(2) == 'order-history' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white "
                            ...
                            <a class="{!! request()->segment(2) == 'profile' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white  "
                            ...
                            <a class="{!! request()->segment(2) == 'change-password' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white   "
                            ...
                            <a class="{!! request()->segment(2) == 'transaction-statements'
                                ? 'bg-[#4456a6] text-white'
                                : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white   "
                            ...
                            <a class="{!! request()->segment(1) == 'track-order' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white   "
                            ...
                            {{-- @if (Auth::guard('customer_registrations')->user()->is_affilate == '1' && Auth::guard('customer_registrations')->user()->status == 'VERIFIED')
                                <a class="{!! request()->segment(2) == 'payment-history' ? 'bg-[#4456a6] text-white' : 'text-[#4456a6] bg-transparent' !!} flex mt-1 items-center px-4 py-3 hover:bg-[#4456a6] hover:text-white   "
