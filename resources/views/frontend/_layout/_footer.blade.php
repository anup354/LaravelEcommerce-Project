<section class="px-16 py-10 max-sm:text-center  w-full mx-auto max-w-screen-2xl">
    <div class="flex gap-8 max-lg:flex-col  ">
        <div class="w-[30%] max-lg:w-full">
            <a href="{{ route('home') }}" class="max-sm:justify-center max-sm:flex"><img
                    src="{{ asset('images/svg/logo-no-background.svg') }}" alt="logo" class="w-40 "></a>
            <div class=" text-gray-500 py-3">"Zupish"</div>
            <div class="flex gap-5 max-sm:justify-center">
                <a href="{{ getSetting()->facebook }}" rel="" target="_blank"
                    class="text-2xl transition ml-2 text-blue-800 hover:opacity-75">
                ...
                <a href="{{ getSetting()->instagram }}" rel="" target="_blank"
                    class="text-2xl transition ml-2 text-blue-800 hover:opacity-75">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 256 256">
                        <g fill="none">
                ...
                {{-- <a href="{{ getSetting()->tiktok }}" rel="" target="_blank"
                    class="text-2xl transition ml-2 text-blue-800 hover:opacity-75">
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="29" viewBox="0 0 256 290">
                        <path fill="#FF004F"
            ...
            <div class="grid grid-cols-3 max-lg:grid-cols-2 max-lg:gap-y-10 max-sm:grid-cols-1">
                ...
                <div class="">
                    ...
                    <div class="flex flex-col pt-5 text-gray-500 gap-y-2">
                        ...
                        <a href="{{ route('termsandcondition') }} "><span>Termsand Conditions</span></a>
                ...
                <div class="">
                    ...
                    <div class="flex flex-col pt-5 text-gray-500 gap-y-2 max-sm:justify-center">
                        ...
                        <span class="flex gap-2 max-sm:justify-center flex-wrap max-sm:mt-4">
                            ...
                            <p>977-{{ getSetting()->contact_number }}</p>
    ...
    <div class="flex justify-between flex-wrap max-sm:justify-center pt-11">
        ...
        <p class="text-sm text-gray-600">© 2023. Zupish. All rights reserved.</p>
        <div class="flex  justify-center flex-wrap max-sm:mt-4">
            <a href="https://softsaro.com" target="_blank">
                <p class="text-sm text-gray-500">
                    Developed by <span class="hover:text-purple-800 font-bold">Anup Kasula.</span>
                </p>
            </a>
