...
<div class="px-20 py-8 max-lg:px-10 max-sm:px-5">
    <div class="flex max-sm:gap-0 gap-6 bg-white  shadow-xl rounded-xl">
            <main class="md:flex-1  flex  md:p-6 p-3 ">
                <div class="max-md:w-full max-sm:mx-5">

                    <div class="pb-6 ">
                        <h1 class="text-3xl font-semibold text-[#f15a28] max-sm:text-center mb-1.5">Sign Up</h1>
                    ...
                    method="POST"
                     class=" max-md:w-full grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="number" id="phone" name="phonenumber"
                                class="mt-1 w-full p-2 border rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm" value="{{ old('phonenumber') }}" />
                                @error('phonenumber')
                                <div class="invalid-feedback text-sm text-[#f15a28]" style="display: block;">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="password" id="Password" name="password"
                                class="mt-1 w-full p-2 border rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm" value="{{ old('password') }}"/>
                                @error('password')
                                <div class="invalid-feedback text-sm text-[#f15a28]" style="display: block;">
                                    {{ $message }}
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="password" id="Passwordfirmation" name="confirm_password"
                                class="mt-1 w-full p-2 border rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"value="{{ old('confirm_password') }}"/>
                        ...
                        <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                            <button
                                class="inline-block shrink-0 rounded-md border border-red-500 bg-red-500 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-[#F1612D] focus:outline-none focus:ring active:text-[#7065d4]">
                                Create an account
                            </button>

                            <p class="mt-4 max-md:mb-5 text-gray-500 sm:mt-0">
                                Already have an account?
                                <a href="{{route('login')}}" class="font-medium text-[#f15a28] underline">Log in</a>.
                            </p>
                        </div>
                    </form>
                    ...
                    <div class="space-y-2 text-sm font-medium max-md:my-6  mt-5">
            ...
            <section class="flex-1">
                <div class="hidden lg:relative md:block h-full">
                    <img src="{{ asset('images/high-fashion-portrait-young.jpg') }}" alt="" class="h-full object-cover rounded-r-xl">
                </div>
            </section>
        </div>
</div>
