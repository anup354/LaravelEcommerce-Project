                            ...
                            <div>
                                <div class="mt-4 ">
                                    ...
                                    @foreach ($attributeItems as $attributegroup)
                                        <div class="text-[#4456a6] font-semibold">
                                        ...
                                        <div class="flex flex-wrap gap-4">
                                            ...
                                            @foreach ($attributes as $key => $attributeitem)
                                                ...
                                                @endphp
                                                @if (strtolower($attributegroup->attribute_group_name) == 'color')
                                                    <div class="my-2">
                                                        ...
                                                        <label for="{{ $attributeitem->attribute_name }}"
                                                            class="inline-flex items-center justify-between w-full p-1 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer peer-checked:border-[#f15a28] peer-checked:text-[#f15a28]  hover:text-gray-600 hover-bg-gray-100">
                                                            <div class="block rounded-full">
                                                                <div
                                                                    class="text-[#4456a6] bg-{{ strtolower($attributeitem->attribute_name) === 'black' || strtolower($attributeitem->attribute_name) === 'white' ? strtolower($attributeitem->attribute_name) : strtolower($attributeitem->attribute_name) . '-500' }} rounded-full border w-6 h-6 mt-1">
                                                                </div>
                                                            </div>
                                                        </label>
                                                    </div>
                                                @else
                                                    <div class="my-2">
                                                        ...
                                                        <label for="{{ $attributeitem->attribute_name }}"
                                                            ...
                                                            <div class="block rounded-full">
                                                                <div
                                                                    class="px-2 py-1 text-gray-600 font-semibold text-center">
                        ...
                        <div class="flex flex-wrap  gap-2 items-center">
                            <div class="flex flex-wrap gap-3 pt-5">
                                ...
                                {{-- @if ($product->product_stock == 0)
                                    Out of Stock
                                @endif --}}
                                <button {{ $product->product_stock == 0 ? 'disabled' : '' }}
                                    class="{{ $product->product_stock == 0 ? 'font-medium bg-[#5096bb] text-white py-2 px-3 rounded-md' : 'font-medium bg-[#4456a6] text-white py-2 px-3 rounded-md' }}
                                        ">ADD
                                    TO CART</button>
                            ...
                            <div class="tooltip">
                                <div wishlistproductId="{{ $product->id }}"
                                    class="product-wishlist mt-5 cursor-pointer flex justify-between font-medium border bg-[#4456a6] text-white py-2 px-3 rounded-md">
                    ...
                    <div class="my-10 flex flex-wrap border ">
                        <div class="flex flex-col p-4">
                            <div class="">
                                ...
                                {{-- <div class="my-4 rounded-xl bg-white py-2 px-4 shadow sm:my-0 ">
