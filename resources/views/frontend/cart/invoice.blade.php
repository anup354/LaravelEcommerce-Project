...
<body class="bg-gray-50 ">
            ...
            <div class="flex flex-col p-4 sm:p-10 bg-white shadow-md rounded-xl ">
                ...
                <div class="flex justify-between">
                    <div>
                        ...
                        <a href="{{ route('home') }}"><img src="{{ asset('images/svg/logo-no-background.svg') }}"
                    ...
                    <div class="text-end">
                        ...
                        <span class="mt-1 block text-gray-500">{{ $order->order_id }}</span>
                ...
                <div class="mt-8 grid sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 ">{{ $billinginfo->billing_name }}</h3>
                        <address class="mt-2 not-italic text-gray-500">
                            {{ $billinginfo->billing_address }}
                        </address>
                        <div class="mt-2 not-italic text-gray-500">
                            {{ $billinginfo->billing_phonenumber }}
                ...
                <div class="mt-6">
                    <div class="border border-gray-200 p-4 rounded-lg space-y-4 ">
                        <div class="hidden sm:grid sm:grid-cols-5">
                            ...
                            <div class="text-end text-xs font-medium text-gray-500 uppercase">Amount <span
                                    class="text-gray-400">( Rs . )</span></div>
                        </div>
                        ...
                        <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
                            @foreach ($order->orderItem as $item)
                                <div class="col-span-full sm:col-span-2">
                                    ...
                                    <div class="flex">
                                        <div class="font-medium text-gray-800 ">{{ $item->product->product_name }} -
                                        </div>
                                        <div class="flex items-center">
                                            @foreach ($item->orderAttributes as $attribute)
                                                <div class=" text-gray-500 p-1 rounded">
                                ...
                                <div>
                                    ...
                                    <p class="sm:text-end text-gray-800 ">
                                        {{ $item->product_price * $item->quantity }}</p>
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="mt-8 flex sm:justify-end">
                    <div class="w-full max-w-2xl sm:text-end space-y-2">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-1 gap-3 sm:gap-2">
                            ...
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 ">Delivery Charge:</dt>
                                <dd class="col-span-2 text-gray-500">Rs. {{ $order->delivery_charge }}</dd>
                            </dl>
                            {{-- <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 ">Subtotal:</dt>
                                <dd class="col-span-2 text-gray-500">Rs . {{ $order->amount }}</dd>
                            </dl> --}}

                            <dl class="grid sm:grid-cols-5 gap-x-3">
                                <dt class="col-span-3 font-semibold text-gray-800 ">Tax:</dt>
                                <dd class="col-span-2 text-gray-500">{{ $order->taxpercent }}%</dd>
                            </dl>
                            <dl class="grid sm:grid-cols-5 gap-x-3">
                ...
                <div class="mt-8 sm:mt-12">
                    ...
                    <div class="mt-2">
                        <p class="block text-sm font-medium text-gray-800 ">example@Zupish.com</p>
                        <p class="block text-sm font-medium text-gray-800 ">977-0000000000</p>
                    </div>
                </div>
    ...
    <div class="mt-6 flex justify-end gap-x-3">
        ...
        <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
            onclick="customPrint(); return false;" href="#">
            <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                stroke-linejoin="round">
