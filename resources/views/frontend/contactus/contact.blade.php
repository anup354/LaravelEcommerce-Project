...
@section('body')
    <div class="max-w-screen-2xl mx-auto p-5 max-md:px-0 px-16">
        @include('admin.message.index')
        <div class="grid grid-cols-1 md:grid-cols-12 border border-[#4456a6]">
            <div class="bg-[#233377] md:col-span-4 p-10 text-white">
                ...
                <div class="flex items-center mt-5">
                    <svg class="h-6 mr-2 text-white" fill="currentColor" version="1.1" id="Capa_1"
                    ...
                    <span class="text-sm">977-0000000000</span>
                    {{-- {{ getSetting()->contact_number }} --}}
            ...
            <form method="POST" action="{{ route('contactus.store') }}" class="md:col-span-8 p-10">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        <label class="block uppercase tracking-wide text-[#4456a6] text-xs font-bold mb-2"
                            for="grid-first-name">
                            Full Name
                        </label>
                        <input
                            class="appearance-none block w-full  text-gray-500 text-sm border  rounded py-3 px-4 leading-tight focus:outline-[#4456a6]"
                            id="grid-full-name" name="fullname" type="text" placeholder="Enter your name"
                            {{ old('fullname') }}>
                        @error('fullname')
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        <label class="block uppercase tracking-wide text-[#4456a6] text-xs font-bold mb-2" for="grid-email">
                            Email
                        </label>
                        <input
                            class="appearance-none block w-full  text-gray-500 text-sm border border-gray-200 rounded py-3 px-4  leading-tight focus:outline-[#4456a6] focus:border-gray-500"
                            id="grid-email" name="email" type="email" placeholder="Enter your email"
                            {{ old('email') }}>
                        @error('email')
                            <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                * {{ $message }}
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input
                            class="appearance-none block w-full  text-gray-500 text-sm border  rounded py-3 px-4 leading-tight focus:outline-[#4456a6]"
                            id="grid-phonenumber" name="phonenumber" type="text" placeholder="Enter your phonenumber"
                            {{ old('phonenumber') }}>
                        @error('phonenumber')
                            <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                * {{ $message }}
                    ...
                    <div class="w-full md:w-1/2 px-3">
                        ...
                        <input
                            class="appearance-none block w-full  text-gray-500 text-sm border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-[#4456a6] "
                            id="grid-subject" name="subject" type="text" placeholder="Enter Subject"
                            value="{{ old('subject') }}">
                        @error('subject')
                            <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                * {{ $message }}
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    ...
                    <div class="flex justify-between mt-3 w-full px-3">
