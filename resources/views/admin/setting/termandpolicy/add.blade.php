...
@section('body')
    <div class="flex gap-4 items-center">
        ...
        <div class="text-xl font-bold">Add Page</div>
    </div>
        ...
        " enctype="multipart/form-data">
            ...
            <div class="p-6  mt-3">
                <div class="flex flex-col">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                name="title" placeholder="Type  title here" type="text" value="{{ old('title') }}" />
                            @error('title')
                    ...
                    <div>
                        <label class="block my-2 text-sm font-medium text-gray-900 " htmlFor="">
                            Page order <span class="italic">( view in order)</span>
                        </label>
                        <div>
                            <input
                                class="border border-gray-300 text-gray-900 text-sm rounded-md  focus:ring-[#7065d4] focus:border-[#7065d4] focus:outline-none block w-full p-2.5"
                                name="order" placeholder="Type order here" type="text" value="{{ old('order') }}" />
                            @error('order')
                                <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                    * {{ $message }}
                                </div>
