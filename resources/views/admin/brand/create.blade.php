...
@section('brand', 'bg-[#F1612D] text-white')
@section('body')
                ...
                <div class="flex flex-col">
                    <div>
                        ...
                        <div>
                            <input
                                ...
                                name="brandname" placeholder="Type brand name here" type="text"
                                value="{{ old('brandname') }}" />
                            @error('brandname')
                    ...
                    <div>
                        ...
                        <div>
                            <input
                                class="border border-gray-300 text-gray-900 text-sm rounded-md  focus:ring-[#7065d4] focus:border-[#7065d4] focus:outline-none block w-full p-2.5"
                                name="brand_order" placeholder="Type Brand order here" type="text"
                                value="{{ old('brand_order') }}" />
                            @error('brand_order')
                                <div class="invalid-feedback text-red-400 text-sm" style="display: block;">
                                    * {{ $message }}
                                </div>
